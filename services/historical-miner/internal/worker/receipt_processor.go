...
// 			var receiptsMap map[uint64][]models.ReceiptRpcDTO
...
// 			}
// 			p.logger.Infof("SUCCESSFULLY PROCESSED: Block %d is complete. Total Transactions: %d, Gas Price: %v.",
// 				blockNumber, len(blockData.Transactions), blockData.GasUsed)
